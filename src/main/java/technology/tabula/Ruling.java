...
public class Ruling extends Line2D.Float {
    ...
    public static List<Ruling> verticalRulingsAt(List<java.lang.Float> positions, Page page) {
        List<Ruling> verticalRulings = new ArrayList<Ruling>(positions.size());
        for (java.lang.Float p: positions) {
